...
| :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| Draft | Initial stage where GRN is created and editable before verification. | User | Yes | Yes | Yes | Store Manager, Store Head, System Admin |
| Submitted | GRN submitted for inventory verification. | User | No | No | Yes | Store Manager, Store Head, Purchase Manager, System Admin |
| Verified | Products verified successfully and stock ready for update. | User | No | No | No | Store Manager, Store Head, Purchase Manager, Accounts Executive, System Admin |
| Partial Verified | Partial products or quantities verified successfully. | User | No | No | No | Store Manager, Store Head, Purchase Manager, Accounts Executive, System Admin |
| Completed | Full receiving and inventory update completed successfully. | User | No | No | No | Store Manager, Store Head, Purchase Manager, Accounts Executive, Auditor, System Admin |
| Cancelled | GRN cancelled due to operational or verification issues. | User | No | No | No | Store Manager, Store Head, Purchase Manager, Auditor, System Admin |
| Rejected | GRN rejected during verification process. | User | No | No | No | Store Manager, Store Head, Purchase Manager, System Admin |
