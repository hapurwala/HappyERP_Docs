...
| Location               | purchase_order_delivery>{delivery_id}>location_id            | Select           | Single Select, Filtered By Warehouse         | Yes      | No        | Must Belong To Selected Warehouse                                                  | Load Location Details        | Warehouse Location        | Select Storage Location         |
