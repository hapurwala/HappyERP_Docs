...
| Product Count | s_prd_brand.`product_count` | Number    | -       | Badge/Body       | Number of Products linked to Brand |     |
...
| Brand Type  | s_prd_brand.`brand_type`  | Dropdown    | Own Brand / Vendor Brand       | Yes      | No        | -                                     | –         | Classification of Brand           | -       |
...
### 2.1.2a Right Section (Brand Logo)
...
---
### 2.1.2c Brand Summary

| Name/Label    | Data Source                 | Component    | Read Only | Description            |
| ------------- | --------------------------- | ------------ | --------- | ---------------------- |
| Product Count | s_prd_brand.`product_count` | Badge/Number | Yes       | Total linked products  |
| Current Stage | s_prd_brand_stage.`name`    | Badge        | Yes       | Current workflow stage |
| Status        | Derived                     | Badge        | Yes       | Active / Closed        |